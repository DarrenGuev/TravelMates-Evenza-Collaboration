...
foreach ($lines as $line) {
    ...
    $checkQuery = "SELECT sms_id FROM sms_received WHERE phone = ? AND message_body = ? AND received_at = ?";
    ...
    $query = "INSERT INTO sms_received (phone, message_body, received_at, raw_data) 
              VALUES (?, ?, ?, ?)";
