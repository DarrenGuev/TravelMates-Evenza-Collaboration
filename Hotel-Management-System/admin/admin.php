            ...
            <div class="col-12 col-lg-10 p-3 p-lg-4">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-6 col-md-3 col-xl">
                        <div class="card text-bg-primary h-100 stat-card">
                    ...
                    <div class="col-6 col-md-3 col-xl">
                        <div class="card text-bg-warning h-100 stat-card">
                            <div class="card-body text-center">
                    ...
                    <div class="col-6 col-md-3 col-xl">
                        <div class="card text-bg-success h-100 stat-card">
                            <div class="card-body text-center">
                    ...
                    <div class="col-6 col-md-3 col-xl">
                        <div class="card text-bg-danger h-100 stat-card">
                            <div class="card-body text-center">
                    ...
                    <div class="col-6 col-md-3 col-xl">
                        <div class="card text-bg-info h-100 stat-card">
                            <div class="card-body text-center">
                ...
                <div class="card" id="tableSection">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="text-muted" id="adminPaginationInfo">
                                Showing <span id="adminShowingStart">0</span>-<span id="adminShowingEnd">0</span> of <span id="adminTotal">0</span>
                            </div>
                            <nav aria-label="Admin table pagination">
                                <ul class="pagination pagination-sm mb-0" id="adminPaginationControls">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="text-muted" id="adminPaginationInfoBottom">
                                Showing <span id="adminShowingStartBottom">0</span>-<span id="adminShowingEndBottom">0</span> of <span id="adminTotalBottom">0</span>
                            </div>
                            <nav aria-label="Admin table pagination bottom">
                                <ul class="pagination pagination-sm mb-0" id="adminPaginationControlsBottom">
                                    <!-- Pagination buttons will be generated by JavaScript -->
                                </ul>
                            </nav>
                        </div>
